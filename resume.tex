...
\name{\textbf{MD. SOROWAR}}{\textbf{MAHABUB RABBY}}
% \position{Software Architect{\enskip\cdotp\enskip}Security Expert}
\address{Baryarhat Pour Shava, Mirsarai, Chittagong, Bangladesh}

\mobile{+880 1521-564157 }
\email{c201032@ugrad.iiuc.ac.bd}
%\dateofbirth{January 1st, 1970}
%\homepage{www.posquit0.com} 
\github{github.com/sorowar-cse}
\linkedin{linkedin.com/in/sorowar-cse}
% \gitlab{gitlab-id}
